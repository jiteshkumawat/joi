...
var xmlNode_1 = require("../../xmlElements/base/xmlNode");
/**
 * The Cell class
 */
...
var CellUtility = /** @class */ (function () {
    ...
    CellUtility.prototype.addCell = function (rn, index, cs, value, type, formula) {
        ...
        var v = new xmlNode_1.XmlNode("v");
        v.value = value;
        cell.children.length = 0;
        switch (type) {
            case "string":
                cell.attribute("t").value = "inlineStr";
                var is = new xmlNode_1.XmlNode("is");
                v.name = "t";
                is.child(v);
                cell.child(is);
                break;
...
//# sourceMappingURL=cellUtility.js.map