...
var Sheet = /** @class */ (function () {
    function Sheet(sheetFile, sheetUtility) {
        var _this = this;
        /**
         ...
         */
        this.selectCell = function (cell, cellRange) {
            return sheetUtility.selectCell(cell, cellRange);
        };
        /**
         ...
         */
        this.selectCells = function (cellRange) {
            return sheetUtility.selectCells(cellRange);
        };
        /**
         ...
         * @returns - SheetFile utility for chaining
         */
        this.freezePane = function (rows, columns) {
            return sheetUtility.freezePane(rows, columns);
        };
        /**
        ...
        this.column = function (options) {
            return sheetUtility.column(options);
        };
        /**
         ...
         * @returns - SheetFile utility for chaining
         */
        this.merge = function (cellRange) {
            return sheetUtility.merge(cellRange);
        };
        /**
         ...
         */
        this.cell = function (row, column, options) {
            return sheetUtility.cell(row, column, options);
        };
    }
    Object.defineProperty(Sheet.prototype, "isActive", {
        /**
...
var SheetUtility = /** @class */ (function () {
     ...
     * @param workbook - WorkbookFile containing sheetFile
     * @param eventBus - Event Bus instance
     * @param name - Name of sheetFile
     */
    function SheetUtility(workbook, eventBus, name) {
        this.eventBus = eventBus;
        this.sheetFile = new sheetFile_1.SheetFile(workbook.totalSheet + 1, name);
        this.triggerInitialize();
        this.bindListeners();
        workbook.addSheet(this.sheetFile);
        if (this.sheetFile.id === 1) {
            this.active();
        }
        this.cellUtility = new cellUtility_1.CellUtility(this.sheetFile, this.eventBus);
        this.sheet = new Sheet(this.sheetFile, this);
    }
    ...
    SheetUtility.prototype.triggerInitialize = function () {
        this.eventBus.trigger("addFile", this.sheetFile);
        this.eventBus.trigger("addContentType", "Override", "application/vnd.openxmlformats-officedocument.spreadsheetml.worksheet+xml", "/" + this.sheetFile.filePath + "/" + this.sheetFile.fileName);
        this.eventBus.trigger("addWorkbookRelation", "sheets/" + this.sheetFile.fileName, "http://schemas.openxmlformats.org/officeDocument/2006/relationships/worksheet", this.sheetFile.id);
    };
    /**
