...
var WorkbookUtilityBuilder = /** @class */ (function () {
    ...
    WorkbookUtilityBuilder.default = function (eventBus) {
        ...
        workbook = new workbookFile_1.WorkbookFile();
        ...
        var workbookUtility = new workbookUtility_1.WorkbookUtility(eventBus, workbook, relations, sharedStringFile);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        _a.label = 2;
                    case 2:
                        sharedStringRel = relation.getRelationshipNode("http://schemas.openxmlformats.org/officeDocument/2006/relationships/sharedStrings");
                        if (!sharedStringRel) return [3 /*break*/, 4];
                        sharedStringRelValue_1 = sharedStringRel.attribute("Target").value;
                    ...
                    case 3:
                        ...
                        _a.label = 4;
                    case 4: return [4 /*yield*/, workbookFile_1.WorkbookFile.load(workbookFile.fileContent, workbookFile.fileName, workbookFile.filePath)];
                    case 5:
                        workbookFileXml = _a.sent();
                        eventBus.trigger("addFile", workbookFileXml);
                        workbookUtility = new workbookUtility_1.WorkbookUtility(eventBus, workbookFileXml, relation, saredStrings);
...
//# sourceMappingURL=workbookUtility.builder.js.map