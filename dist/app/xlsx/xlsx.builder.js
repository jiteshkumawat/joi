...
var workbookUtility_builder_1 = require("./workbookUtility.builder");
var XlsxBuilder = /** @class */ (function () {
    ...
    XlsxBuilder.default = function (fileName) {
        ...
        contentTypes = this.initContentTypes(files);
        this.bindListeners(contentTypes, files, eventBus);
        var workbookUtility = workbookUtility_builder_1.WorkbookUtilityBuilder.default(eventBus);
        this.initRels(files, contentTypes);
        return new xlsx_1.Xlsx(fileName, files, workbookUtility);
    };
    /**
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, self.loadContentTypes(fileAdapters, files)];
                    case 3:
                        _contentTypes = _a.sent();
                        contentTypes = _contentTypes;
                        self.bindListeners(contentTypes, files, eventBus);
                        workbookUtility = workbookUtility_builder_1.WorkbookUtilityBuilder.default(eventBus);
                        return [4 /*yield*/, self.loadRelationships(fileAdapters, files, contentTypes)];
                    case 4:
                        _a.sent();
                        xlsx = new xlsx_1.Xlsx(fileName, files, workbookUtility);
                        if (callback) {
                            callback(xlsx);
                        }
     ...
     */
    XlsxBuilder.initContentTypes = function (files) {
     ...
     */
    XlsxBuilder.bindListeners = function (contentTypes, files, eventBus) {
    ...
    XlsxBuilder.initRels = function (files, contentTypes) {
        ...
        relationships.addRelationship(contentTypes.overrides["application/vnd.openxmlformats-officedocument.spreadsheetml.sheet.main+xml"].trim("/"), "http://schemas.openxmlformats.org/officeDocument/2006/relationships/officeDocument");
        return relationships;
    };
    XlsxBuilder.loadContentTypes = function (files, xmls) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, contentTypes_1.ContentTypes.load(contentTypesFile)];
                    case 1:
...
//# sourceMappingURL=xlsx.builder.js.map