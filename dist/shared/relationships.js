...
var Relationships = (function (_super) {
    ...
    function Relationships(fileName) {
        var _this = _super.call(this, new xmlRootNode_1.XmlRootNode("Relationships", "http://schemas.openxmlformats.org/package/2006/relationships"), fileName || ".rels") || this;
        _this.Id = 1;
        return _this;
    }
